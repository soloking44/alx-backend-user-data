#!/usr/bin/env python3
""" Process of basic_auth user authentication
"""
...
class BasicAuth(Auth):
    """ Expands BasicAuth class
    """
    def extract_base64_authorization_header(self, auth_header: str) -> str:
        """ Remove base64 authorization header """
    ...
    def decode_base64_authorization_header(self, b64_auth_header: str) -> str:
        """ Outputs decode base64 authorization """
    ...
    def user_object_from_credentials(
        ...
        """ Outputs user item in credentials """
